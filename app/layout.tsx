...
export const metadata: Metadata = {
  ...
  keywords: ['FREE', 'R&B', 'Detroit', 'FINExME', 'SINE NOCTIS', 'Other World', 'OWJV'],
  authors: [{ name: 'FREE' }],
  openGraph: {
    title: 'NOT-AVAILABLE',
    description: 'Welcome to the Other World.',
    url: 'https://atnocost.cc',
    siteName: 'FREE',
    locale: 'en_US',
    type: 'website',
    images: [{ url: '/opengraph-image.png', width: 1200, height: 630, alt: 'NOT-AVAILABLE' }],
  },
  twitter: {
